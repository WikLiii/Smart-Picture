...
import com.wjh.smartpicturebackend.manager.sharding.DynamicShardingManager;
import com.wjh.smartpicturebackend.model.dto.space.SpaceAddRequest;
import com.wjh.smartpicturebackend.model.dto.space.SpaceQueryRequest;
...
import com.wjh.smartpicturebackend.model.enums.SpaceTypeEnum;
...
* @createDate 2026-03-20 18:41:56
*/
@Service
    ...
    //  3. 校验权限，非管理员只能创建普通级别的空间
        ...
        synchronized (lock) {
            ...
            Long newSpaceId = transactionTemplate.execute(status -> {
                ...
                ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR,"保存数据到数据库失败");
