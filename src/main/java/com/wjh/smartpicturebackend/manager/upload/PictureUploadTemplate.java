package com.wjh.smartpicturebackend.manager.upload;
...
public  abstract class PictureUploadTemplate {
    ...
    public UploadPictureResult uploadPicture(Object inputSource, String uploadPathPrefix) {
        ...
        //自定义拼接文件上传路径，而不是使用原始文件名称，可以增强安全性
        ...
        try {
            ...
            if(CollUtil.isNotEmpty(objectList)){
                ...
                CIObject compressedCiObject = objectList.get(0);//压缩图规则
                CIObject thumbnailCiObject = compressedCiObject;//默认为压缩图
                //有生成缩略图，才获取缩略图
                if (objectList.size() > 1) {
                    thumbnailCiObject = objectList.get(1);//缩略图规则
                }
